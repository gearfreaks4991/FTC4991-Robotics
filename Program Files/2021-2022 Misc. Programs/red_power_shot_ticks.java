...
@Autonomous(name="red_power_shot_ticks")
public class red_power_shot_ticks extends LinearOpMode {
...
//        Rotation.setTargetPosition(0);
        ...
        BR.setPower(1.00);
        BL.setPower(1.00);
        FL.setTargetPosition(3600);
        FR.setTargetPosition(3600);
        BL.setTargetPosition(3600);
        BR.setTargetPosition(3600);
        ...
        BL.setPower(1.00);
        BR.setPower(1.00);
        FL.setTargetPosition(FL.getCurrentPosition() - 1612);
        FR.setTargetPosition(FR.getCurrentPosition() + 1612);
        BL.setTargetPosition(BL.getCurrentPosition() + 1612);
        BR.setTargetPosition(BR.getCurrentPosition() - 1612);
        telemetry.addData("FL Position", FL.getCurrentPosition());
        telemetry.addData("FR Position", FR.getCurrentPosition());
        telemetry.addData("BL Position", BL.getCurrentPosition());
        telemetry.addData("BR Position", BR.getCurrentPosition());
